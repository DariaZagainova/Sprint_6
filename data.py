...
# Содержаниие ответов "Вопросы о важном" на главной странице
class AnswerTexts:
...
# Данные для заполнения формы заказа на странице оформления заказа
order_form_data = [
    {
        "name": "Иван",
        "last_name": "Иванов",
        ...
        "phone": "+71111111111",
        "date_order": "15.09.2025",
        "term_order": "трое суток",
        "colour": "серая безысходность"
    },
    {
        "name": "Мария",
        "last_name": "Петрова",
        "address": "г. Москва, ул. Энтузиастов, д. 15",
        "metro_station": "Черкизовская",
        "phone": "+72222222222",
        "date_order": "05.10.2025",
        "term_order": "семеро суток",
        "colour": "чёрный жемчуг"
    }
]

# Цвета самоката в блоке с чекбоксами выбора цвета на странице оформлениия заказа
colours = {
    "black": "чёрный жемчуг",
